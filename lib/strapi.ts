// Strapi CMS Client with Fallback Data and i18n Support (Next.js Server-Side)
// Configure STRAPI_URL in .env.local to connect to your Strapi instance
...
// Revalidation time for Next.js fetch caching (5 minutes)
...
// Server-side fetch from Strapi with Next.js caching
...
const fallbackPageSEOEn: Record<PageSEOKey, SEOData> = {
  'home': {
    ...
    twitterImage: '/og-images/home-twitter.jpg',
  },
  'about': {
    ...
    twitterImage: '/og-images/about-twitter.jpg',
  },
  'outdoor-farm': {
    ...
    ogImage: '/og-images/outdoor-farm-og.jpg',
    twitterImage: '/og-images/outdoor-farm-twitter.jpg',
  },
  'indoor-farm': {
    ...
    ogImage: '/og-images/indoor-farm-og.jpg',
    twitterImage: '/og-images/indoor-farm-twitter.jpg',
  },
  'educational-activities': {
    ...
    ogImage: '/og-images/educational-activities-og.jpg',
    twitterImage: '/og-images/educational-activities-twitter.jpg',
  },
  'commercial-real-estate': {
    ...
    ogImage: '/og-images/commercial-real-estate-og.jpg',
    twitterImage: '/og-images/commercial-real-estate-twitter.jpg',
  },
  'corporations': {
    ...
    ogImage: '/og-images/corporations-og.jpg',
    twitterImage: '/og-images/corporations-twitter.jpg',
  },
  'schools': {
    ...
    canonical: '/schools',
    ogImage: '/og-images/schools-og.jpg',
    twitterImage: '/og-images/schools-twitter.jpg',
  },
  'careers': {
    ...
    twitterImage: '/og-images/careers-twitter.jpg',
  },
  'partnerships': {
    ...
    ogImage: '/og-images/partnerships-og.jpg',
    twitterImage: '/og-images/partnerships-twitter.jpg',
  },
  'community-engagement': {
    ...
    ogImage: '/og-images/community-engagement-og.jpg',
    twitterImage: '/og-images/community-engagement-twitter.jpg',
  },
  'contact': {
    ...
    twitterImage: '/og-images/contact-twitter.jpg',
  },
  'faq': {
    ...
    canonical: '/faq',
    ogImage: '/og-images/faq-og.jpg',
    twitterImage: '/og-images/faq-twitter.jpg',
  },
  'blog': {
    ...
    canonical: '/blog',
    ogImage: '/og-images/blog-og.jpg',
    twitterImage: '/og-images/blog-twitter.jpg',
  },
  'cities': {
    ...
    twitterImage: '/og-images/cities-twitter.jpg',
  },
  'privacy-policy': {
    ...
    noIndex: true,
    ogImage: '/og-images/privacy-policy-og.jpg',
    twitterImage: '/og-images/privacy-policy-twitter.jpg',
  },
  'terms-of-service': {
...
export async function getPageSEO(pageKey: PageSEOKey, locale: Locale = 'en'): Promise<SEOData> {
  const fallback = fallbackPageSEO[locale]?.[pageKey] || fallbackPageSEO.en[pageKey];
...
export async function getCitySEO(citySlug: string, locale: Locale = 'en'): Promise<SEOData | null> {
  if (!STRAPI_URL) {
    return null;
  }
  ...
  try {
    ...
    const url = `${STRAPI_URL}/api/cities?filters[slug][$eq]=${citySlug}&populate=seo.ogImage,seo.twitterImage&locale=${locale}`;
