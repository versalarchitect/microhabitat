...
import { ArrowLeft, ArrowRight, Calendar, Tag, User, Share2, Linkedin, Facebook, Twitter } from "lucide-react";
          ...
          <div className="border-t border-border pt-8 mt-12">
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="flex gap-3">
                ...
                <a
                  href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}&quote=${encodeURIComponent(`${post.title} - ${post.excerpt}`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 border border-border rounded-md hover:bg-muted transition-colors"
