...
const faqData = {
  "General Urban Farming Queries": [
    ...
    },
    {
      ...
      answer: "Requirements include at least 200 sq ft (20m²) of space, adequate sunlight (minimum 6 hours daily), accessible water sources, and safe roof access if applicable. Our team can assess your specific situation during a free consultation.",
    },
    {
  ...
  "Technical": [
    ...
    },
    {
      ...
      answer: "A minimum of 200 sq ft (20m²) of accessible space is required for an outdoor farm. Indoor solutions can work with smaller spaces.",
    },
    {
...
export function FAQPage({ onBookDemo }: FAQPageProps) {
  ...
  return (
    <>
      ...
      />
      <StructuredData schema={generateFAQSchema(allFaqs)} />
